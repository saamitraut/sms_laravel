        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-md-6"><div class="mb-3">
...
<div class='modal fade' id='basicModall{{ $i }}' tabindex='-1' aria-hidden='true'>
    ...
    <div class="form-group">
        ...
        <input type="text" value="{{ $sms_broadcaster->ID}}" class="form-control" id="ID" name="ID">
    </div>
    <div class="form-group">
        
        <label for="BROADCASTERNAME">BROADCASTERNAME:</label>
        <input type="text" value="{{ $sms_broadcaster->BROADCASTERNAME}}" class="form-control" id="BROADCASTERNAME" name="BROADCASTERNAME">
    </div>
    <div class="form-group">
        
        <label for="BROADCASTERDESC">BROADCASTERDESC:</label>
        <input type="text" value="{{ $sms_broadcaster->BROADCASTERDESC}}" class="form-control" id="BROADCASTERDESC" name="BROADCASTERDESC">
    </div>
    <div class="form-group">
        
        <label for="CREATEDON">CREATEDON:</label>
        <input type="text" value="{{ $sms_broadcaster->CREATEDON}}" class="form-control" id="CREATEDON" name="CREATEDON">
    </div>
    <div class="form-group">
        
        <label for="UPDATEDON">UPDATEDON:</label>
        <input type="text" value="{{ $sms_broadcaster->UPDATEDON}}" class="form-control" id="UPDATEDON" name="UPDATEDON">
    </div>
    <div class="form-group">
        
        <label for="CREATEDBY">CREATEDBY:</label>
        <input type="text" value="{{ $sms_broadcaster->CREATEDBY}}" class="form-control" id="CREATEDBY" name="CREATEDBY">
    </div>
    <div class="form-group">
        
        <label for="UPDATEDBY">UPDATEDBY:</label>
        <input type="text" value="{{ $sms_broadcaster->UPDATEDBY}}" class="form-control" id="UPDATEDBY" name="UPDATEDBY">
    </div>
    <div class="form-group">
        
        <label for="STATUS">STATUS:</label>
        <input type="text" value="{{ $sms_broadcaster->STATUS}}" class="form-control" id="STATUS" name="STATUS">
    </div>
    <div class="form-group">
        
        <label for="Deleted">Deleted:</label>
        <input type="text" value="{{ $sms_broadcaster->Deleted}}" class="form-control" id="Deleted" name="Deleted">
    </div>
    <div class="form-group">
        
        <label for="Remark">Remark:</label>
        <input type="text" value="{{ $sms_broadcaster->Remark}}" class="form-control" id="Remark" name="Remark">
    </div>
    <div class="form-group">
        
        <label for="sms_id">sms_id:</label>
        <input type="text" value="{{ $sms_broadcaster->sms_id}}" class="form-control" id="sms_id" name="sms_id">
    </div>
